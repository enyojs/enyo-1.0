enyo.kind({
	...
	components: [
		{kind: "DbService", dbKind: "com.palmdts.canondblist:1", onFailure: "dbFail", components: [
		...
		{kind: "MockDb", dbKind: "com.palmdts.canondblist:1", onSuccess: "queryResponse", onWatch: "queryWatch"},
