...
enyo.kind({
	...
	components: [
		{kind: "HFlexBox", flex: 1, defaultKind: "DialpadButton", components: [
			...
			{kind: "IconButton", flex: 1, value: "backspace", layoutKind: "VFlexLayout", pack: "center",  className: "dialpadbutton-bottom-back dialpad-backspace", icon: "$enyo-lib/telephony/images/dialpad-backspace.png", onclick: "handleBackspace", onmousehold: "handleClear"}
		]}
	],
	create: function(){
		this.inherited(arguments);
