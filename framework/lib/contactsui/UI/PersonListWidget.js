...
//		enyo.log("||||||||||PERSON LIST WIDGET - SET EXCLUSIONS : running this.$.PersonList.setExclusions with array" + JSON.stringify(this.exclusions));
...
//		enyo.log("PERSON LIST WIDGET - RENDERED - calling changemode on personList with " + this.mode);
	...
	ready: function () {
//		enyo.log("|||||||| PERSON LIST WIDGET IN READY");
		if (this.exclusions && Array.isArray(this.exclusions)) {
//			enyo.log("||||||||||PERSON LIST WIDGET - READY : this.exclusions is an array, running this.$.PersonList.setExclusions with array" + JSON.stringify(this.exclusions));
			this.$.list.setExclusions(this.exclusions);
		}
//		enyo.log("|||||||||||||||||MODE : " + this.mode);
...
//		enyo.log("THE SEARCH TERM IS: " + this.filterString);
