enyo.kind({
	...
	components: [
		{name: "label", height:"30px", components: [
			{name: "Text", content: rb_auth.$L("Device Locked"), style: "font-family: Prelude Medium; font-size: 20px; text-align: center; color: white; weight: bold;"},
	...
	pinSetChanged: function() {
		if (this.pinSet){
			...
			this.$.Text.setContent(rb_auth.$L("Device Locked"));
