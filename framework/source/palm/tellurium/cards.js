...
Tellurium.getViewNameByPaneId = function(paneId) {
	if (!Tellurium.enyo.windows.getActiveWindow()) throw { message : "getViewNameByPaneId() in TelluriumNub - app stage is not the active window." };
...
Tellurium.isStageActive = function() {
	if (typeof Tellurium.enyo.windows.getActiveWindow() === "object")
		return true;
	return false;
};
